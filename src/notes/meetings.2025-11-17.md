...
They discussed the possibility of using velcro bags that act as [faraday cages](https://en.wikipedia.org/wiki/Faraday_cage), so that the student could keep the phone in their backpack, but it wouldn't be functional until it was removed from the bag. There was also some mention of having a centralized location for the cell phones to be stored. Each solution has is limitations and the board has asked Mr. Golden and his team to figure out an implementation strategy.

### Five Year Capital Plan

The board also voted on their Five Year Capital Plan, which is how they tell the [[glossary.county commission]] what to expect from their budget requests for the next five years. It is not binding, but it gives a good indication of where money will be spent. For instance this year, the board is requesting $4m for a renovation at Grassland Middle and $17m is being requested to start work on a new elementary school on the "Split Log Property" which will need another $43m in each of the 27-28 and 28-29 budgets to complete it.
